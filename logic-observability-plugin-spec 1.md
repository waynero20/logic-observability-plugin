...
1. [Decisions Pre-Made](#decisions-pre-made)
2. [The IR Schema](#the-ir-schema)
3. [Milestone 1: Project Setup](#milestone-1-project-setup)
4. [Milestone 2: TypeScript Scanner](#milestone-2-typescript-scanner)
5. [Milestone 3: TypeScript Extractor](#milestone-3-typescript-extractor)
6. [Milestone 4: Generators](#milestone-4-generators)
7. [Milestone 5: Standalone Viewer](#milestone-5-standalone-viewer)
8. [Milestone 6: Claude Code Commands](#milestone-6-claude-code-commands)
9. [Milestone 7: Plugin Packaging](#milestone-7-plugin-packaging)
10. [Reference: Architecture Diagram](#reference-architecture-diagram)
11. [Reference: Existing Proof of Concept](#reference-existing-proof-of-concept)
